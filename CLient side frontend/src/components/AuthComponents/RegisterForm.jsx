...
const RegisterForm = () => {
  ...
  return (
    <div className='max-w-[500px] mx-auto bg-white mt-14'>
      ...
      <p className='text-center mt-2'> continue with <button onClick={handleGoogleSignIn} className='text-blue underline'>Google</button> </p>
      <form onSubmit={handleRegisterSubmit} className="card-body">
        ...
        <div className="form-control mt-6">
          <button className="btn text-white text-base md:text-lg font-medium bg-blue hover:bg-blue opacity-90 hover:opacity-100"> Register </button>
        </div>
