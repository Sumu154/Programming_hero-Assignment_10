...
import ThemeToggle from '../ToggleComponents/ThemeToggle';
...
const Navbar = () => {
  ...
  return (
    <div className="navbar w-[90%] mx-auto dark:text-white ">
      <div className="navbar-start">
        <div className="dropdown   dark:bg-cardbackground">
        ...
        <Link to='/' className="text-blue text-base sm:text-2xl font-bold"> Crowd Funding  </Link>
      </div>
